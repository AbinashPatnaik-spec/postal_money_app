        ...
        <div className="row my-3">
          ...
          <div className="col-md-8">
            <div className="card border-danger">
              <h4 className="card-header text-bg-danger text-center">Reach Us</h4>
              <div className="card-body">
                <h5 className="card-title">To Open a new account or know more about our Product and Services:</h5>
                <p className="card-text"><i className="bi bi-telephone"></i> Call us 155299/033-22029000</p>
                <p className="card-text"><i class="bi bi-envelope-at"></i> Email to us at contact@ippbonline.in</p>
                <p className="card-text"><i class="bi bi-buildings"></i> Visit your nearest Branch / Access Point</p>
              </div>
            </div>
          </div>
          <div className="col-md-2"></div>
